        <section style="height: 100%; width: 100%; box-sizing: border-box; background-color: #f5f5f5">
            <div class="d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif">
                ...
                <div class="right-content-3-5">
                    ...
                    <h3 class="title-text-content-3-5">Silahkan Masuk</h3>
                    <p class="caption-text-content-3-5">
                    Silahkan masuk menggunakan akun yang sudah dibuatkan <br />
                    oleh Superadmin ke dalam website
                    </p>
                    <?= $this->session->flashdata('message'); ?>
                    <form class="user" method="POST" style="margin-top: 1.5rem" action="<?= base_url('auth'); ?> ">
                    <div style="margin-bottom: 1.75rem">
                        ...
                        <input class="input-field-content-3-5" type="text" name="email" id="email" placeholder="Your Email Address" value="<?= set_value('email'); ?>" autocomplete="on" required />
                    ...
                    <div style="margin-top: 1rem">
                        ...
                        <input class="input-field-content-3-5" type="password" name="password" id="password" placeholder="Your Password" minlength="6" required />
                    ...
                    <div class="text-right" style="margin-top: 0.75rem">
                        <a href="<?= base_url('auth/forgotpassword'); ?>" class="forgot-password-content-3-5 font-italic">Forgot Password?</a>
                    </div>
                    <button class="btn text-white btn-fill-content-3-5 d-block w-100" type="submit">Log In To My Account</button>
                    </form>
